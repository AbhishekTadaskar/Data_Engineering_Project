# This file Creates a database in SQL and load the .xml files in a table in SQL
...
connection = pymysql.connect(
    host='localhost',
    user='root',
    password='9881',   # Change if needed
    autocommit=True
)
...
"""pymysql.err.ProgrammingError: (1064, "You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'exist BigMart' at line 1")"""